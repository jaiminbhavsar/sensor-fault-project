...
class DataInjestion:
    def __init__(self,data_ingestion_config:DataIngestionConfig):
        try:
            ...
            logging.info("Data Injestion Configuration")
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = sensor_data.export_collection_as_dataframe(collection_name=self.data_injestion_config.collection_name)
    ...
    def initiate_data_injestion(self)-> DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact = DataIngestionArtifact(trained_file_path=self.data_injestion_config.training_file_path,
